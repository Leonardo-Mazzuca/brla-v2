...
import { z } from "zod";
import { FormActions, useForm as innerUseForm } from "../../../context/Register/FormContext";
...
import { DEFAULT_ICON_SIZE, DEFAULT_TEXT_SIZE, GAP_DEFAULT, ROUNDED_DEFAULT, TEXT_GRAY_400, TEXT_GRAY_800 } from "../../../contants/classnames/classnames";
...
<input
  ...
  className={`checkbox:h-3/4 bg-gray-50 border border-gray-300 text-gray-900
  text-sm ${ROUNDED_DEFAULT} focus:ring-blue-500 focus:border-blue-500 block w-full
  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
  dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
        ...
        <div className="my-3">
          ...
          <div className={`flex ${GAP_DEFAULT} my-3 md:items-center items-start`}>
            ...
            flex-wrap ${GAP_DEFAULT} ${TEXT_GRAY_400} text-sm md:${DEFAULT_TEXT_SIZE}`}>
              ...
              I agree with
              <a href="#" className={`flex items-center ${TEXT_GRAY_800} hover:underline`}>
